...
class UserAdapter2(private var mUser: List<User>?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.user_item_layout, parent, false) // user_item_layout.xml là layout cho mỗi item trong RecyclerView
